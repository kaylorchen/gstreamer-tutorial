...
//           NULL);
//  data.pipeline = gst_parse_launch ("playbin uri=https://dl8.webmfiles.org/big-buck-bunny_trailer.webm", NULL);
  data.pipeline = gst_parse_launch ("playbin uri=file:///home/kaylor/sintel_trailer-480p.webm", NULL);
